const zh_TW = {
    "static": {
        ...
        "motivation_message_2": "For Indie Game Developers, simply getting a game noticed therefore becomes an even more monumental task than in the past. Naturally due to limited resources, Indie Developers face an increasingly difficult task to raise awareness about their games.",
        "motivation_memo": '1 "• Number of games released on Steam 2018 | Statistic - Statista." Accessed May 29, 2019.',
        "developers_title": "Developers",
        "developers_sub_title": "Here are some pain points that Game Developers face:",
        "developers_resources_title": "Resources",
        "developers_resources_message": "Despite having great ideas, many teams are unable to fully execute their visions due to physical limitations such as team size or technical expertise.",
        "developers_competition_title": "Competition",
        "developers_competition_message": "With an increasing number of games released per year, catching the attention of players is increasingly difficult.",
        "developers_isolability_title": "Isolability",
        "developers_isolability_message": "Most games exist in isolation and do not have interactions with other games, even from the same developer.",
        "developers_alliances_title": "Alliances",
        "developers_alliances_message": "With the increasing amount of competition and how most games work in isolation, there’s a strong need for smaller developers to form alliances more than ever. However, due to the lack of resources, this is usually closer to being a fantasy than a practical strategy.",
        "gamers_title": "Gamers",
        "gamers_sub_title": "Gamers face a similar set of pain points, but from the other perspective.",
        "gamers_ownership_title": "Ownership",
        "gamers_ownership_message": "Many games in recent years sell virtual items, whether directly or via loot box mechanics. Unlike how traditionally owning a game meant having a physically copy, this ownership model means players are at the mercy of the developer’s servers. Players own the items only if the servers are alive and the developer doesn’t run out of business.",
        "gamers_addiction_title": "Addiction",
        "gamers_addiction_message": "A game that’s considered addicting is usually a good thing, meaning that it’s fun and players want to come back to play. However, after a certain point, this becomes unhealthy.",
        ...
        "roadmap_pos_title": "Proof of Stake chain implementation",
        "roadmap_pos_message": "This is the actual implementation of the chain itself.",
        "roadmap_testnet_title": "Testnet Launch",
        "roadmap_testnet_message": "While we do intend to launch testnet with a version of a mobile wallet and auction website, they will be far from complete. They will act as a springboard for potential partners to imagine what the release product may look like, and for us to receive feedback and feature requests.",
        "roadmap_gameSdk_title": "Game Developer SDK",
        "roadmap_gameSdk_message": "An SDK for developers to connect their games, enabling them to generate and retrieve assets that their game supports.",
        ...
        "about_aetheras_message_1": "As software developers, we aim to create software to improve lives, whether through solving problems, providing entertainment, or both. We believe that blockchain technology offers the world huge opportunities for innovation with its ability to promote transparency and fairness.",
        "about_aetheras_message_2": "For discussions, join us on our Discord channel:"
    },
    "technology": [
        {
            "icon": "/images/icon-block.svg",
            "title": "中文假文",
            "content": "這些談論的人，這一點不能明白，他倆人中的一個，一邊，救死且沒有工夫，不要爭一爭氣，我的意見，擋不住大的拳頭，夢寐中也只見得金錢的寶光，他倆疲倦了，有最古的文明，行動上也有些忙碌，不斷地逝去，一到夜裡，一個有年紀的人，所有一切，用什麼做根據？"
        },
        {
    ...
    "founder": [
        {
            "photo": "/images/member_pho-1.png",
            "name": "Denis Tsai",
            "description": "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore."
        },
        {
            "photo": "/images/member_pho-2.png",
            "name": "Teddy Lee",
            "description": "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore."
        }
    ],
    "about_us": {
        "message1": "Aetheras aims to create software to improve lives, whether through solving problems, providing entertainment, or both.",
        "message2": "Our first project is a blockchain developed in house to service the gaming industry’s trading market. The project's research and development will enable us to build applications for many more verticals in the future.",
        "message3": "We believe blockchain technology, with its ability to promote transparency and fairness, offers the world huge opportunities for innovation.",
    },
    "team_member": [
        {
            "name": "名字",
            ...
            "github": "https://github.com/aetheras-io",
            "linked_in": "https://www.aetheras.io/",
